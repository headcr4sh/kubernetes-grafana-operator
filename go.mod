module github.com/headcr4sh/kubernetes-grafana-operator
...
require (
	...
	k8s.io/api v0.0.0-20190223013602-d9cc2872cf08
	k8s.io/apiextensions-apiserver v0.0.0-20190223021434-fd174c437ae0
